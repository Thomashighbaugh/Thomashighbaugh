...
module.exports = async function (data) {
  ...
  const formatJson = (elem) =>
    `<a href="${
      elem.html_url
    }"><img height=200 width=350 src="https://github-readme-stats.vercel.app/api/pin/?username=${
      data.user
    }&repo=${encodeURIComponent(
      elem.name,
    )}&title_color=FE3B7B&text_color=F2F2F2&bg_color=3c3c3c&border_color=525053&icon_color=F2F2F2&border_width=2&border_radius=20"/></a>`;
