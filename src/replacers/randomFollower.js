...
module.exports = async function (data) {
  ...
  return `<a href="${follower.html_url}" alt="${follower.name}"><img style="height:150px; overflow:none !important;" src=./src/resources/images/${imageName} alt="Follower of the day"/></a>`;
};
